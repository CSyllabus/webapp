...
mdh_course_json = open("mdh_courses.json")
mdh_fixtures_json = open("../fixtures/mdh_fixtures_json.json", "w")
mdh_courses = json.load(mdh_course_json)
